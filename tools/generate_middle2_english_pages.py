...
PARENT = "과목별학원"
CATEGORY = "중2영어학원"
TITLE_SUFFIX = " 중2 영어학원"
SUBJECT_LABEL = "중2 영어"
SUBJECT = "영어"
SUBJECT_EN = "ENGLISH"
GRADE_TEXT = "중학교 2학년"
FOCUS_LABEL = "내신·서술형 대비"
ZIP_PATH = BASE / "참고자료" / "사용한 원고" / "영수학원.com 추가 원고" / "중2 영어학원.zip"
...
SIBLING_CATEGORY_META: dict[str, str] = {
    ...
    "중2영어학원": f"중2 영어 {FOCUS_LABEL} 지역별 안내",
    "중3수학학원": "중3 수학 내신·오답·고입 대비 지역별 안내",
    "중3영어학원": "중3 영어 어휘·구문·독해·서술형 지역별 안내",
}
...
# 이 원고 배치는 수학 원고와 형식이 살짝 다르다: FAQ 답변 표기가 "A1."이 아니라
# "A."이고, 학부모후기에는 "※ 가상 예시" 안내문 없이 "학부모 후기 1/2"만 있다.
# ---------------------------------------------------------------------------
...
COMPARE_ROWS: list[dict[str, str]] = [
    ...
    {"label": "내신 대비", "other": "지문 반복 풀이 위주", "ours": "학교별 진도·범위에 맞춘 개별 확인"},
    ...
    return {
        ...
        "@graph": [
            ...
            },
            {
                ...
                "knowsAbout": [SUBJECT_LABEL, "내신 대비", "서술형 관리", "학습 상담"],
                "makesOffer": [
...
def detail_page(
    ...
    rep_path = shared.choose_random_rep_image(local, slug, "me2eng")
    ...
    fit_section = f"""    <section class="section">
      ...
      <div class="card-grid">
        ...
        <article class="info-card"><span class="tag">추천</span><h3>이런 학생에게 추천</h3><p>과제는 하는데 오답 이유를 설명하지 못하는 학생, 단어는 아는데 지문 해석에서 막히는 학생, 내신 서술형 대비를 체계적으로 시작하려는 학생에게 적합합니다.</p></article>
      </div>
