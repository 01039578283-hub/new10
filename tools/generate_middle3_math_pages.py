...
PARENT = "과목별학원"
CATEGORY = "중3수학학원"
TITLE_SUFFIX = " 중3 수학학원"
SUBJECT_LABEL = "중3 수학"
SUBJECT = "수학"
SUBJECT_EN = "MATH"
GRADE_TEXT = "중학교 3학년"
FOCUS_LABEL = "내신전략·오답관리"
ZIP_PATH = BASE / "참고자료" / "사용한 원고" / "영수학원.com 추가 원고" / "중3 수학학원.zip"
...
SIBLING_CATEGORY_META: dict[str, str] = {
    ...
    "중3수학학원": f"중3 수학 {FOCUS_LABEL} 지역별 안내",
...
# 이 원고 배치는 FAQ가 "Q1./A1."도 "Q1./A."도 아니라 번호 없는 "Q./A."이다.
# 학부모후기는 다른 배치처럼 빈 줄로 구분된 note + quote 구조라 기존 parse_review 재사용 가능.
# ---------------------------------------------------------------------------
...
COMPARE_ROWS: list[dict[str, str]] = [
    ...
    {"label": "내신전략", "other": "성적 보장 문구 위주 설명", "ours": "기록·정기 점검으로 변화 확인"},
    ...
    return {
        ...
        "@graph": [
            ...
            },
            {
                ...
                "knowsAbout": [SUBJECT_LABEL, "내신전략", "오답 관리", "학습 상담"],
                "makesOffer": [
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} {SUBJECT_LABEL} 진단 상담", "serviceType": "TutoringService"}},
                    {"@type": "Offer", "itemOffered": {"@type": "Service", "name": f"{local} 내신전략 관리", "serviceType": "TutoringService"}},
