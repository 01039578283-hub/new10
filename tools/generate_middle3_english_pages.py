...
def detail_page(
    ...
    fit_section = f"""    <section class="section">
      ...
      <div class="card-grid">
        ...
        <article class="info-card"><span class="tag">학년</span><h3>{esc(GRADE_TEXT)}</h3><p>같은 학년이라도 어휘·문법·독해·서술형 중 약한 영역이 다르므로 진단 후 우선순위를 다르게 잡습니다.</p></article>
        <article class="info-card"><span class="tag">추천</span><h3>이런 학생에게 추천</h3><p>시험 직전 몰아치기에서 벗어나 누적 복습을 시작해야 하는 학생, 고1 연계까지 고려한 학습을 준비하려는 학생, 내신 서술형 대비를 체계적으로 시작하려는 학생에게 적합합니다.</p></article>
      </div>
